<template>
  <div class="page-container">
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 mb-1">文章分类管理</h1>
        <p class="text-sm text-gray-500">管理系统文章分类结构</p>
      </div>
...
import { getCategoryTree, createCategory, updateCategory, deleteCategory } from '@/api/article'
